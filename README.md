...
<a href="mailto:yogeshgadekar141@gmail.com">
...
![SQL](https://img.shields.io/badge/SQL-Expert-4479A1?style=for-the-badge&logo=database&logoColor=white)
...
|------------|----------|--------------|
| 🫀 Heart Disease Analytics | Power BI · DAX · Healthcare Analytics | 299 patient records analysed with 68% survival rate insights |
| 🧠 Brain Tumor Analytics | Power BI · Power Query · DAX | 10,000 patient records analysed across tumor grades & brain regions |
| 🧬 Alzheimer's MRI Analytics | Python · Power BI · Image Processing | 36,000+ MRI scans processed with feature extraction & disease-stage analysis |
| 🍕 Food Delivery Analytics | Power BI · DAX | 15,100+ orders analysed with KPI reporting |
| 👥 HR Analytics | Tableau | 17.31% attrition analysis & workforce insights |
| 🛒 Grocery Store Analytics | Power BI | ₹1.20M+ sales performance dashboard |
| 🐍 Python Sales EDA | Python · Pandas | Customer segmentation & trend analysis |
| 📚 SQL Online Bookstore | SQL · PostgreSQL | Normalized schema & query optimization |
| 📈 Excel Sales | Excel · Power Query | ₹5.82M+ revenue analysis |
...
Google Data Analytics • Google Business Intelligence • Power BI • SQL • Tableau • Python • Power Query • Advanced Excel • Generative AI
...
Analytical Thinking • Problem Solving • Data Storytelling • Team Collaboration • Communication • Attention to Detail
